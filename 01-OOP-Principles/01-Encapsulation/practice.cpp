...
// ============================================================
// This is your working copy of before_encapsulation.cpp.
// Experiment, refactor, and improve this code.
// If you need a fresh start, copy the contents of before_encapsulation.cpp back.
// Compare your work with after_encapsulation.cpp when done.
// ============================================================
