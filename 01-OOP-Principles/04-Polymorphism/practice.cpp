...
// ============================================================
// This is your working copy of before_polymorphism.cpp.
// Experiment, refactor, and improve this code.
// If you need a fresh start, copy the contents of before_polymorphism.cpp back.
// Compare your work with after_polymorphism.cpp when done.
// ============================================================
