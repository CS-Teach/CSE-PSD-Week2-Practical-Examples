...
// ============================================================
// This is your working copy of before_abstraction.cpp.
// Experiment, refactor, and improve this code.
// If you need a fresh start, copy the contents of before_abstraction.cpp back.
// Compare your work with after_abstraction.cpp when done.
// ============================================================
